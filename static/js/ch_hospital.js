  ...
  const translations = {
    en: {
      ...
      messages: {
        ...
        cantonComparisonTitle: 'Case frequency per 100k patients treated in this canton',
        cantonComparisonLead:
          'Cases per 100k treated patients: {cantonRate} for patients treated in {canton} vs {nationalRate} nationwide.',
        cantonComparisonHigher:
          'In {canton}, the rate is {difference} cases per 100,000 treated patients higher than the national average.',
        cantonComparisonLower:
          'In {canton}, the rate is {difference} cases per 100,000 treated patients lower than the national average.',
        ...
        cantonComparisonAxisLabel: 'Cases per 100k treated patients',
    ...
    de: {
      ...
      messages: {
        ...
        cantonComparisonTitle: 'Fallhäufigkeit pro 100 000 behandelte Patientinnen und Patienten in diesem Kanton',
        cantonComparisonLead:
          'Fälle pro 100 000 behandelte Patientinnen und Patienten: {cantonRate} bei in {canton} behandelten Personen vs {nationalRate} schweizweit.',
        cantonComparisonHigher:
          'Im Kanton {canton} liegt die Rate um {difference} Fälle pro 100 000 behandelte Patientinnen und Patienten über dem nationalen Durchschnitt.',
        cantonComparisonLower:
          'Im Kanton {canton} liegt die Rate um {difference} Fälle pro 100 000 behandelte Patientinnen und Patienten unter dem nationalen Durchschnitt.',
        ...
        cantonComparisonAxisLabel: 'Fälle pro 100 000 behandelte Patientinnen und Patienten',
    ...
    fr: {
      ...
      messages: {
        ...
        cantonComparisonTitle: 'Fréquence des cas pour 100 000 patients traités dans ce canton',
        cantonComparisonLead:
          'Cas pour 100 000 patients traités : {cantonRate} pour les patients traités dans {canton} contre {nationalRate} au niveau suisse.',
        cantonComparisonHigher:
          'Dans le canton de {canton}, le taux dépasse la moyenne nationale de {difference} cas pour 100 000 patients traités.',
        cantonComparisonLower:
          'Dans le canton de {canton}, le taux est inférieur à la moyenne nationale de {difference} cas pour 100 000 patients traités.',
        cantonComparisonEven: '{canton} est aligné sur la moyenne nationale.',
        cantonComparisonLabelNational: 'Suisse',
        cantonComparisonLabelCanton: 'Canton {canton}',
        cantonComparisonAxisLabel: 'Cas pour 100 000 patients traités',
    ...
    it: {
      ...
      messages: {
        ...
        cantonComparisonTitle: 'Frequenza dei casi per 100 000 pazienti trattati in questo cantone',
        cantonComparisonLead:
          'Casi per 100 000 pazienti trattati: {cantonRate} per i pazienti trattati in {canton} rispetto a {nationalRate} a livello svizzero.',
        cantonComparisonHigher:
          'Nel cantone {canton} il tasso supera la media nazionale di {difference} casi ogni 100 000 pazienti trattati.',
        cantonComparisonLower:
          'Nel cantone {canton} il tasso è inferiore alla media nazionale di {difference} casi ogni 100 000 pazienti trattati.',
        ...
        cantonComparisonAxisLabel: 'Casi per 100 000 pazienti trattati',
