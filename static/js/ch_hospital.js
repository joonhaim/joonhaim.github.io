  ...
  function renderTopList(agg) {
    ...
    finderList.innerHTML = toDisplay
      .map((h, idx) => {
        ...
        const nameLength = h.hospital.length;
        const nameClass =
          nameLength > 45
            ? 'finder-hospital-name finder-hospital-name--xsmall'
            : nameLength > 32
            ? 'finder-hospital-name finder-hospital-name--small'
            : 'finder-hospital-name';
        return `
          <div class="finder-row">
            <span class="finder-rank">${startIndex + idx + 1}</span>
            <div class="finder-hospital">
              <div class="finder-hospital-header">
                <strong class="${nameClass}">${h.hospital}</strong>
